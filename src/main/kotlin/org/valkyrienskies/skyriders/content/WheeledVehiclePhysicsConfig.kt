...
data class WheeledVehiclePhysicsConfig(
    ...
    companion object {
        ...
        val TRUCK = WheeledVehiclePhysicsConfig(
            ...
            driftEnabled = true,
            driftMinSpeed = 5.4,
            driftStartSteer = 0.18,
            driftSteerableGripScale = 0.78,
            driftNonSteerableGripScale = 0.26,
            driftYawAssist = 1650.0,
            driftBrakeScale = 0.0,
            driftDriveScale = 0.96,
            driftExitSmoothingTime = 0.22,
            driftTopSpeedMultiplier = 1.18,
            driftUprightStrengthScale = 1.48,
            driftUprightDampingScale = 1.34,
            driftBoostEnabled = true,
            driftBoostMaxLevel = 3,
            driftBoostChargeTimes = listOf(0.85, 1.7, 2.65),
            driftBoostForces = listOf(13000.0, 19000.0, 27000.0),
            driftBoostDurations = listOf(0.45, 0.68, 0.95),
            transmission = VehicleTransmissionConfig(
                automatic = false,
                manualClutch = true,
                finalDriveRatio = 3.85,
                reverseGearRatio = 3.4,
                forwardGears = listOf(
                    VehicleTransmissionGearConfig(maxSpeed = 6.0, torqueMultiplier = 2.15, launchTorqueScale = 1.0, gearRatio = 3.65),
                    VehicleTransmissionGearConfig(maxSpeed = 11.5, torqueMultiplier = 1.58, launchTorqueScale = 0.76, gearRatio = 2.45),
                    VehicleTransmissionGearConfig(maxSpeed = 17.0, torqueMultiplier = 1.08, launchTorqueScale = 0.48, gearRatio = 1.68),
                    VehicleTransmissionGearConfig(maxSpeed = 22.5, torqueMultiplier = 0.82, launchTorqueScale = 0.24, gearRatio = 1.22),
                    VehicleTransmissionGearConfig(maxSpeed = 27.0, torqueMultiplier = 0.66, launchTorqueScale = 0.12, gearRatio = 0.92),
                    VehicleTransmissionGearConfig(maxSpeed = 30.0, torqueMultiplier = 0.54, launchTorqueScale = 0.06, gearRatio = 0.74)
                ),
                reverseTopSpeed = 5.0,
